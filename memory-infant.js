		...
		const score = turnCounter;
		 $.ajax({
            ...
            success: function(data){
               $('.board').html('<br><h4>You win!<br>Done in '+turnCounter+' turns<br>HIGHSCORE<br></h4><div style="overflow-x:hidden;"><iframe frameborder="0" src="highscore.php" width="200" height="200" scrolling="yes"></iframe><div><br><form></form><h4><a href="index.html">RETURN</a></h4>');
            }
        });  
}
